...
indiedown makes it easy to generate a customized RMarkdown PDF template.
...
To create your own, customized RMarkdown template, start by creating an indiedown template package:
